...
function setup() {
  ...
  function draw() {
    ...
    beginShape();
    vertex(200, 180);
    bezierVertex(210 + xOffset, 115, 210 + xOffset*2, 85, 180 + xOffset*3, 0);
    vertex(190 + xOffset*3, 0);
    bezierVertex(220 + xOffset*2, 85, 220 + xOffset, 115, 210, 180);
    endShape(CLOSE);
  
    strokeWeight(5);
    noFill();
    bezier(200, 180, 210 + xOffset, 115, 210 + xOffset*2, 85, 180 + xOffset*3, 0); 
    ...
    // manage animation
    if (xOffset > 10 || xOffset < -10) moveSpeed *= -1;
    xOffset += moveSpeed;
